...
def main_worker(gpu, ngpus_per_node, log_queue, args):
    ...
    if args.train_data is None:
        if args.distillation:
            ...
            evaluate(teacher_model, data, start_epoch, args, writer, 0, results_fname="teacher_results.jsonl", distill_model_type="teacher")
        else:
        ...
        if args.distillation:
            ...
            evaluate(teacher_model, data, 0, args, writer, 0, results_fname="teacher_results.jsonl", distill_model_type="teacher")
        else:
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if args.val_data is not None:
            if args.distillation:
                ...
                evaluate(teacher_model, data, epoch + 1, args, writer, steps, results_fname="teacher_results.jsonl", distill_model_type="teacher")
            else:
