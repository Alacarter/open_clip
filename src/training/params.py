...
def get_default_params(model_name):
    ...
    if model_name in ["RN50", "RN50-small", "RN101", "RN50x4"]:
        return {"lr": 5.0e-4, "beta1": 0.9, "beta2": 0.999, "eps": 1.0e-8}
    elif model_name in ["ViT-B/32", "ViT-B/16", "ViT-B/16-small"]:
...
def parse_args():
    ...
    parser.add_argument(
        "--model",
        choices=["RN50", "RN50-small", "RN101", "RN50x4", "ViT-B/32", "ViT-B/16", "ViT-B/16-small"],
        default="RN50",
